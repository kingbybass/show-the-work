...
## Captured Steps
1. `01-register-form.png` - Registration entry point and parent account setup
2. `02-register-feedback.png` - Registration feedback and system response
3. `03-parent-tutorial.png` - Parent onboarding and capability introduction
4. `04-task-design-preview.png` - Task templates, assignment, and publish-preview flow
